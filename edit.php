	...
	<form action="?act=add" id="signupok" method="post" name="addform"  enctype="multipart/form-data">
       <input type="hidden" name="artid" value="<?php echo time().rand(10,1000);?>" />
        ...
        <dl class="clearfix">
          ...
          <div class="btn_box">
        <input type="button" name="signup" class="button" value="直接发布文章" onClick="window.open('add_article.php');" style="width:49%;height:30px;line-height:30px" align="left">
        <input type="button" name="signup" class="button" value="会员购买" onClick="window.open('hygm.php');" style="width:49%;height:30px;line-height:30px" align="right" >
      </div>
