...
background: #fff;"></dd>
		...
		<div class="blank10" style="margin-bottom:10px;"></div>
			<center> <input type="button" name="signup" class="button" value="广告在线制作" onClick="window.open('http://xiuxiu.web.meitu.com/main.html');" style="width:40%;height:30px;line-height:30px"></center>
		</div>
        <dl class="clearfix">
...
background: #fff;"></dd>
		...
		<div class="blank10" style="margin-bottom:10px;"></div>
			 ...
			 <center> <input type="button" name="signup" class="button" value="二维码在线制作" onClick="window.open('http://cli.im');" style="width:40%;height:30px;line-height:30px" ></center>
		</div>
