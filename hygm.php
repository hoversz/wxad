...
<div class="apply" id="apply">
  ...
  <div class="list1">
		...
		<ul>
			...
			<li class="STYLE1" style='font-size:20px'><font color=red> 一年会员:</font><span style=" text-decoration:line-through; color:red; font-size:20px">500元</span><span style="font-weight:bold;color:green; font-size:20px">=现价:388元</span>
					...
					<li class="STYLE1" style='font-size:18px'><font color=red> 接中小企业代理/年:</font><span style=" text-decoration:line-through; color:red; font-size:18px">11800元</span><span style="font-weight:bold;color:green; font-size:18px">=现价:8800元</span>
...
<li style='font-size:18px'><strong><font color=#0000FF> 客服联系:15003849290</font></strong></li>


<li style='font-size:18px'><strong><font color=#0000FF> 微信客服：zhu2du</font></strong></li>
